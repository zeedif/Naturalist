...
public class Capybara extends Animal implements GeoEntity {
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.of(NaturalistTags.ItemTags.CAPYBARA_FOOD);
    ...
    protected <E extends Capybara> PlayState predicate(final AnimationState<E> event) {
