...
public class NaturalistEntityTypes {
    ...
    public static final Supplier<EntityType<Capybara>> CAPYBARA = CommonPlatformHelper.registerEntityType("capybara", Capybara::new, MobCategory.CREATURE, 1.4F, 1.4F, 10);
    ...
    public static final Supplier<EntityType<Crab>> CRAB = CommonPlatformHelper.registerEntityType("crab", Crab::new, MobCategory.CREATURE, 0.7F, 0.7F, 10);
    ...
    public static final Supplier<EntityType<EmperorPenguin>> EMPEROR_PENGUIN = CommonPlatformHelper.registerEntityType("emperor_penguin", EmperorPenguin::new, MobCategory.CREATURE, 0.8F, 1.7F, 10);
    ...
    public static final Supplier<EntityType<Moose>> MOOSE = CommonPlatformHelper.registerEntityType("moose", Moose::new, MobCategory.CREATURE, 1.4F, 2.1F, 10);
//    public static final Supplier<EntityType<Ostrich>> OSTRICH = CommonPlatformHelper.registerEntityType("ostrich", Ostrich::new, MobCategory.CREATURE, 1.4F, 2.1F, 10);
    ...
    public static final Supplier<EntityType<Toucan>> TOUCAN = CommonPlatformHelper.registerEntityType("toucan", Toucan::new, MobCategory.CREATURE, 0.7F, 0.7F, 10);
